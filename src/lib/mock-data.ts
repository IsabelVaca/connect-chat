...
export const conversations: Record<string, Message[]> = {
  ...
  michael: [
    ...
    { id: "m2", from: "me", text: "Yes! Moving in around the 1st.", time: "4:20 PM" },
    {
      id: "m3",
      from: "them",
      text: "Sounds good, let's talk about the lease terms tomorrow.",
      time: "4:25 PM",
    },
  ],
  emily: [
    { id: "e1", from: "them", text: "Hi there, loved your profile!", time: "11:05 AM" },
    {
      id: "e2",
      from: "them",
      text: "I have a golden retriever, is it pet friendly?",
      time: "11:06 AM",
    },
  ],
};
...
export const userProfiles: UserProfile[] = [
  {
    ...
    compatibility: 92,
    photo:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuDvAn89_4C3RstRpHXxpg9B254C55jqUsK778KDMxA5U9QGCVf5PSS1blzjGLsahSUHGaOQ1JqkhMSJP95zhMkOxPUJp5UeU8DbBZHzz56p2nvYGa-FFK28llExBPu3rliG0MBRBVtErXBYnHc1H9aU_Wxt7o-aa9_ybEo61Sj49g4N1gwpcyGbbX5Nf31ZrKkLA7YEaareQKP4zYFqAumJR4rrlFUsdwq8tqhyF1edHQfSGJTPoyFh",
